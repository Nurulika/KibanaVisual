...
#[derive(Debug)]
pub struct KibanaVisualProcessor {
    verbose: bool,
    processed_count: usize,
}

impl KibanaVisualProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting KibanaVisual processing");
    
    let mut processor = KibanaVisualProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = KibanaVisualProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = KibanaVisualProcessor::new(false);
